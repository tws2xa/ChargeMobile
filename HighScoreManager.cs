...
namespace Charge
{
    ...
    class HighScoreManager
    {
        ...
        //Where the high score file is stored
        ...
        public HighScoreManager()
        {
            ...
            IsolatedStorageFileStream highScoreFileStream;

            if (!store.FileExists(fileName))
            {
                highScoreFileStream = store.OpenFile("HighScores.txt", FileMode.OpenOrCreate);
        ...
        public void updateHighScore(int finalScore)
        {
            ...
            IsolatedStorageFileStream highScoreFileStream = store.OpenFile("HighScores.txt", FileMode.OpenOrCreate);
            using (StreamWriter writer = new StreamWriter(highScoreFileStream))
            {
        ...
        public void LoadHighScores()
        {
            ...
            IsolatedStorageFileStream highScoreFileStream = store.OpenFile("HighScores.txt", FileMode.Open);
